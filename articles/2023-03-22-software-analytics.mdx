...
I always was inspired be the idea to make developers' more efficient and achieve better code quality to maintain code sanity. I worked with few tools which helped me to achieve some level of it, among them are:
