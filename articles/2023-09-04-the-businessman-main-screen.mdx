...
But, there is no any interactivity, and everything is static. That's fine for now, in the next article we will add some
interactivity, we will use JavaScript for it. After that we will start working on the other screens.
