...
If you look into the final code you will see that adding more and more functionality will lead us very quickly to the point where the code will become very hard to maintain. We will fix this in the next article, where I'll introduce you to basic refactoring techniquies.
